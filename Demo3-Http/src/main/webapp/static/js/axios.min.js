...
!function (e, t) {
    ...
    var k, T = Object.prototype.toString, j = Object.getPrototypeOf, A = Symbol.iterator, P = Symbol.toStringTag,
    ...
    var F = N("ArrayBuffer");
    var B = _("string"), D = _("function"), q = _("number"), I = function (e) {
        ...
        }, z = N("Date"), H = N("File"), J = N("Blob"), W = N("FileList"), K = N("URLSearchParams"),
        V = b(["ReadableStream", "Request", "Response", "Headers"].map(N), 4), G = V[0], X = V[1], $ = V[2], Y = V[3];

    function Q(e, t) {
        var r, n, o = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}, i = o.allOwnKeys,
            a = void 0 !== i && i;
        if (null != e) if ("object" !== f(e) && (e = [e]), C(e)) for (r = 0, n = e.length; r < n; r++) t.call(null, e[r], r, e); else {
    ...
    var re, ne = (re = "undefined" != typeof Uint8Array && j(Uint8Array), function (e) {
    ...
    var ue, ce, fe, le, pe = N("AsyncFunction"),
        he = (ue = "function" == typeof setImmediate, ce = D(ee.postMessage), ue ? setImmediate : ce ? (fe = "axios@".concat(Math.random()), le = [], ee.addEventListener("message", (function (e) {
        ...
        ve = {
            ...
            merge: function e() {
                ...
                }, i = 0, a = arguments.length; i < a; i++) arguments[i] && Q(arguments[i], o);
                return n
            },
            ...
            freezeMethods: function (e) {
                se(e, (function (t, r) {
                    ...
                    var n = e[r];
                    D(n) && (t.enumerable = !1, "writable" in t ? t.writable = !1 : t.set || (t.set = function () {
    ...
    ["ERR_BAD_OPTION_VALUE", "ERR_BAD_OPTION", "ECONNABORTED", "ETIMEDOUT", "ERR_NETWORK", "ERR_FR_TOO_MANY_REDIRECTS", "ERR_DEPRECATED", "ERR_BAD_RESPONSE", "ERR_BAD_REQUEST", "ERR_CANCELED", "ERR_NOT_SUPPORT", "ERR_INVALID_URL"].forEach((function (e) {
        be[e] = {value: e}
    })), Object.defineProperties(ye, be), Object.defineProperty(me, "isAxiosError", {value: !0}), ye.from = function (e, t, r, n, o, i) {
    ...
    function Se(e, t, r) {
        ...
        function c(e, r, o) {
            var s = e;
            if (e && !o && "object" === f(e)) if (ve.endsWith(r, "{}")) r = n ? r : r.slice(0, -2), e = JSON.stringify(e); else if (ve.isArray(e) && function (e) {
        ...
        var l = [], p = Object.assign(Oe, {defaultVisitor: c, convertValue: u, isVisitable: ge});
    ...
    var Ae = function () {
        ...
        }(), Pe = {silentJSONParsing: !0, forcedJSONParsing: !0, clarifyTimeoutError: !1}, Le = {
            isBrowser: !0,
            classes: {
        ...
        Fe = Ne && window.location.href || "http://localhost", Be = s(s({}, Object.freeze({
            __proto__: null,
            hasBrowserEnv: Ne,
    ...
    function De(e) {
        function t(e, r, n, o) {
            ...
            return i = !i && ve.isArray(n) ? n.length : i, s ? (ve.hasOwnProp(n, i) ? n[i] = [n[i], r] : n[i] = r, !a) : (n[i] && ve.isObject(n[i]) || (n[i] = []), t(e, r, n[i], o) && ve.isArray(n[i]) && (n[i] = function (e) {
    ...
    var Ke = function (e, t) {
        ...
        return y(r, [{
            key: "set", value: function (e, t, r) {
                ...
                if (ve.isPlainObject(e) || e instanceof this.constructor) i(e, t); else if (ve.isString(e) && (e = e.trim()) && !/^[-_a-zA-Z0-9^`|~,!#$%&'*+.]+$/.test(e.trim())) i(function (e) {
                    var t, r, n, o = {};
                    return e && e.split("\n").forEach((function (e) {
                        n = e.indexOf(":"), t = e.substring(0, n).trim().toLowerCase(), r = e.substring(n + 1).trim(), !t || o[t] && Me[t] || ("set-cookie" === t ? o[t] ? o[t].push(r) : o[t] = [r] : o[t] = o[t] ? o[t] + ", " + r : r)
                    })), o
                }(e), t); else if (ve.isObject(e) && ve.isIterable(e)) {
            ...
            key: "accessor", value: function (e) {
                var t = (this[ze] = this[ze] = {accessors: {}}).accessors, r = this.prototype;
    ...
    Ke.accessor(["Content-Type", "Content-Length", "Accept", "Accept-Encoding", "User-Agent", "Authorization"]), ve.reduceDescriptors(Ke.prototype, (function (e, t) {
    ...
    function Ge(e, t) {
        var r = this || Ie, n = t || r, o = Ve.from(n.headers), i = n.data;
    ...
    function st(e, t) {
        ...
        function n(e, t, r, n) {
            return ve.isPlainObject(e) && ve.isPlainObject(t) ? ve.merge.call({caseless: n}, e, t) : ve.isPlainObject(t) ? ve.merge({}, t) : ve.isArray(t) ? t.slice() : t
        }
    ...
    var ut, ct, ft = function (e) {
            var t, r, n = st({}, e), o = n.data, i = n.withXSRFToken, a = n.xsrfHeaderName, s = n.xsrfCookieName,
                u = n.headers, c = n.auth;
            if (n.headers = u = Ve.from(u), n.url = je(it(n.baseURL, n.url, n.allowAbsoluteUrls), e.params, e.paramsSerializer), c && u.set("Authorization", "Basic " + btoa((c.username || "") + ":" + (c.password ? unescape(encodeURIComponent(c.password)) : ""))), ve.isFormData(o)) if (Be.hasStandardBrowserEnv || Be.hasStandardBrowserWebWorkerEnv) u.setContentType(void 0); else if (!1 !== (t = u.getContentType())) {
            ...
            return new Promise((function (t, r) {
                var n, o, i, a, s, u = ft(e), c = u.data, f = Ve.from(u.headers).normalize(), l = u.responseType,
                ...
                })), ve.isUndefined(u.withCredentials) || (v.withCredentials = !!u.withCredentials), l && "json" !== l && (v.responseType = u.responseType), h) {
                    var m = b(et(h, !0), 2);
        ...
        gt = mt && ("function" == typeof TextEncoder ? (ut = new TextEncoder, function (e) {
            return ut.encode(e)
        }) : function () {
    ...
    mt && (ct = new Response, ["text", "arrayBuffer", "blob", "formData", "stream"].forEach((function (e) {
    ...
    var xt = function () {
        ...
        var e = h(u().mark((function e(t) {
            ...
            return u().wrap((function (e) {
                for (; ;) switch (e.prev = e.next) {
                    case 0:
                        if (r = ft(t), n = r.url, o = r.method, i = r.data, a = r.signal, c = r.cancelToken, f = r.timeout, l = r.onDownloadProgress, p = r.onUploadProgress, h = r.responseType, d = r.headers, v = r.withCredentials, y = void 0 === v ? "same-origin" : v, m = r.fetchOptions, h = h ? (h + "").toLowerCase() : "text", g = pt([a, c && c.toAbortSignal()], f), E = g && g.unsubscribe && function () {
                            g.unsubscribe()
                        }, e.prev = 4, e.t0 = p && Et && "get" !== o && "head" !== o, !e.t0) {
                            e.next = 11;
                            break
                        }
                    ...
                    case 11:
                        ...
                        S = new Request(n, {
                            ...
                            body: i,
                            duplex: "half"
                        }), ve.isFormData(i) && (x = S.headers.get("content-type")) && d.setContentType(x), S.body && (R = tt(O, et(rt(p))), k = b(R, 2), T = k[0], j = k[1], i = yt(S.body, 65536, T, j));
                    case 15:
                        return ve.isString(y) || (y = y ? "include" : "omit"), A = "credentials" in Request.prototype, w = new Request(n, s(s({}, m), {}, {
                            signal: g,
                    ...
                    case 20:
                        return P = e.sent, L = Ot && ("stream" === h || "response" === h), Ot && (l || L && E) && (N = {}, ["status", "statusText", "headers"].forEach((function (e) {
                            N[e] = P[e]
                        })), _ = ve.toFiniteNumber(P.headers.get("content-length")), C = l && tt(_, et(rt(l), !0)) || [], U = b(C, 2), F = U[0], B = U[1], P = new Response(yt(P.body, 65536, F, (function () {
                            B && B(), E && E()
                        })), N)), h = h || "text", e.next = 26, St[ve.findKey(St, h) || "text"](P, t);
                    case 26:
    ...
    var jt = function (e) {
        ...
        for (var t, r, n = (e = ve.isArray(e) ? e : [e]).length, o = {}, i = 0; i < n; i++) {
            var a = void 0;
            if (r = t = e[i], !At(t) && void 0 === (r = Tt[(a = String(t)).toLowerCase()])) throw new ye("Unknown adapter '".concat(a, "'"));
            if (r) break;
            o[a || "#" + i] = r
        }
        if (!r) {
    ...
    function Nt(e) {
        return Lt(e), e.headers = Ve.from(e.headers), e.data = Ge.call(e, e.transformRequest), -1 !== ["post", "put", "patch"].indexOf(e.method) && e.headers.setContentType("application/x-www-form-urlencoded", !1), Pt(e.adapter || Ie.adapter)(e).then((function (t) {
            return Lt(e), t.data = Ge.call(e, e.transformResponse, t), t.headers = Ve.from(t.headers), t
        }), (function (t) {
            return Xe(t) || (Lt(e), t && t.response && (t.response.data = Ge.call(e, e.transformResponse, t.response), t.response.headers = Ve.from(t.response.headers))), Promise.reject(t)
        }))
    }
    ...
    Ct.transitional = function (e, t, r) {
        function n(e, t) {
            return "[Axios v1.10.0] Transitional option '" + e + "'" + t + (r ? ". " + r : "")
        }
    ...
    var Ft = {
        ...
        return y(e, [{
            ...
            key: "_request", value: function (e, t) {
                ...
                }, !1), null != o && (ve.isFunction(o) ? t.paramsSerializer = {serialize: o} : Ft.assertOptions(o, {
                    encode: Bt.function,
                    serialize: Bt.function
                }, !0)), void 0 !== t.allowAbsoluteUrls || (void 0 !== this.defaults.allowAbsoluteUrls ? t.allowAbsoluteUrls = this.defaults.allowAbsoluteUrls : t.allowAbsoluteUrls = !0), Ft.assertOptions(t, {
    ...
    var Jt = function e(t) {
        ...
        return ve.extend(n, qt.prototype, r, {allOwnKeys: !0}), ve.extend(n, r, null, {allOwnKeys: !0}), n.create = function (r) {
            return e(st(t, r))
        }, n
    }(Ie);
    return Jt.Axios = qt, Jt.CanceledError = $e, Jt.CancelToken = Mt, Jt.isCancel = Xe, Jt.VERSION = _t, Jt.toFormData = Se, Jt.AxiosError = ye, Jt.Cancel = Jt.CanceledError, Jt.all = function (e) {
    ...
    }, Jt.mergeConfig = st, Jt.AxiosHeaders = Ve, Jt.formToJSON = function (e) {
        return De(ve.isHTMLForm(e) ? new FormData(e) : e)
    }, Jt.getAdapter = Pt, Jt.HttpStatusCode = Ht, Jt.default = Jt, Jt
}));
